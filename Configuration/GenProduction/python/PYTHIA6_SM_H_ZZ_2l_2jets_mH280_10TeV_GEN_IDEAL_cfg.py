...
# with command line options: Configuration/GenProduction/python/PYTHIA6_SM_H_ZZ_2l_2jets_mH280_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_31X::All --fileout PYTHIA6_SM_H_ZZ_2l_2jets_mH280_10TeV_GEN_IDEAL.root --python_filename PYTHIA6_SM_H_ZZ_2l_2jets_mH280_10TeV_GEN_IDEAL_cfg.py --mc --dirout H280ZZllqq/ -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6 SM H->ZZ->2l2jets at 10TeV with mH=280 GeV'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('H280ZZllqq/PYTHIA6_SM_H_ZZ_2l_2jets_mH280_10TeV_GEN_IDEAL.root'),
