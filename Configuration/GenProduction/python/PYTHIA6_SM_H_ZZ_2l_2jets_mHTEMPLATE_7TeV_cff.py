...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
	    ...
	    'PMAS(25,1)=<HIGGSMASS>.0  ! mass of Higgs',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string(
        '$Source: /cvs_server/repositories/CMSSW/UserCode/Tosi/Configuration/GenProduction/python/PYTHIA6_SM_H_ZZ_2l_2jets_mHTEMPLATE_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 SM H->ZZ->2l2jets at 7TeV with mH=<HIGGSMASS> GeV')
)
