...
class VBFHZZllbbDeltaRAnalyzer : public edm::EDAnalyzer {
   public:
      explicit VBFHZZllbbDeltaRAnalyzer(const edm::ParameterSet&);
      ~VBFHZZllbbDeltaRAnalyzer();
  ...
  TH1D * h_jet_etaVSphysicsEtaResolution;
  TH2D * h_jet_etaVSphysicsEta;
  TProfile * p_jet_etaVSphysicsEta;
