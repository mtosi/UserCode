...
//
 ...
 private:
  ...
  int ZafterDeltaRcutCounter_;
  int ZbeforeDeltaRcutCounter_;
  int ZafterLeptonShiftedEtaCutCounter_;
  int ZbeforeLeptonShiftedEtaCutCounter_;
  ...
  TH1D * ZbeforeDeltaRcutNumber_;
  TH1D * ZafterDeltaRcutNumber_;
  TH1D * ZbeforeLeptonShiftedEtaCutNumber_;
  TH1D * ZafterLeptonShiftedEtaCutNumber_;
...
//  TH1D * OfflinejetTKtagmassS2_;
  ...
  TH1D * recJetsInvMass_;
  TH2D * recJetsInvMassVSjetShiftedEta_;
  TH2D * recJetsInvMassVSdeltaR_;
  ...
  TH1D * recZllMass_leptonicZcutsAFTERZdileptonMass;
  TH1D * recHlljj_leptonicZcutsAFTERZdileptonMass;
  TH1D * recZllMass_leptonicZcutsAFTERZleptonDeltaR;
  TH1D * recHlljj_leptonicZcutsAFTERZleptonDeltaR;
  TH1D * recZjjMass_hadronicZcutsAFTERZdijetMass;
  TH1D * recHlljj_hadronicZcutsAFTERZdijetMass;
  TH1D * recZjjMass_hadronicZcutsAFTERZjetDeltaR;
  TH1D * recHlljj_hadronicZcutsAFTERZjetDeltaR;
  TH1D * recFWDjj_hadronicZcutsAFTERjetDeltaR;
  TH1D * recZleptonsShitedEta_hadronicZcutsAFTERjetDeltaR;
  TH1D * recFWDjjPtBalance_hadronicZcutsAFTERjetDeltaR;
  TH1D * recHlljj_FWDcutsAFTERleptonsShiftedEta;
  TH1D * recHlljj_FWDcutsAFTERjetsShiftedEta;
  TH1D * recHlljj_FWDcutsAFTERforwardDiJetMass;
  TH1D * recHlljj_FWDcutsAFTERpTbalance;
  TH1D * recHZZdeltaR_FWDcutsAFTERpTbalance;
  TH1D * recHlljj_final_;
